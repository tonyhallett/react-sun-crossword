...
var TicTacToeSquare = /** @class */ (function (_super) {
    ...
    TicTacToeSquare.prototype.render = function () {
        var _this = this;
        return React.createElement("td", { style: { width: 100, height: 100, border: "1px", borderColor: "black" }, onClick: function () { _this.props.squareGo; } }, this.props.squareGo === SquareGo.None ? "" : this.props.squareGo);
    };
...
var TicTacToeBoard = /** @class */ (function (_super) {
    ...
    TicTacToeBoard.prototype.render = function () {
        return React.createElement("table", { style: { borderCollapse: "collapse", border: "1px", borderColor: "black" } },
